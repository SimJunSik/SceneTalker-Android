...
public class MyLikeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyLikeAdapter(Context context, int resourceId, List<FeedInfo>dataList){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_HEADER) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.my_feed_like_head, parent, false);
            holder = new MyLikeAdapter.HeaderViewHolder(view);
        } else {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_feed, parent, false);
            holder = new MyLikeAdapter.ItemViewHolder(view);
        }
        return holder;
    }
